...
If your use case is less about querying existing actors and more about creating workers to perform tasks and tracking their lifecycle, the [Supervisor and Worker](supervisor-worker.md) pattern is a more natural fit. Workers report back to the supervisor when they're done, and the supervisor tracks who's still outstanding.
