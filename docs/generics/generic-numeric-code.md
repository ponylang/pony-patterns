...
You want to write a class that works with any unsigned integer type. A block cipher component, say, that stores a value and provides parity checking and XOR operations. The obvious approach is to use `Unsigned` as the type constraint:
